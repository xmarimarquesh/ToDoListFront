    ...
    return (
        <div className="flex flex-row items-center justify-center">
            ...
            <div className="flex flex-col gap-4 ml-2">
                <Image src={require("@/assets/trash.png")}  alt="" className="w-6 h-6 cursor-pointer hover:opacity-50" />
                <Image src={require("@/assets/edit.png")} alt="" className="w-6 h-6 cursor-pointer" />
            </div>
        </div>
